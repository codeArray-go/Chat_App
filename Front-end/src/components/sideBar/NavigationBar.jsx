<<<<<<< HEAD
import { Settings, Search, Heart, MessageCircleIcon } from "lucide-react";
...
const NavigationBar = () => {
  ...
  const { setSearchBarOpen, setNotificationCenteOpen, isSelectedUserFromList } =
    UseChatStore();
  ...
  return (
    <div
      className={`${isSelectedUserFromList ? "hidden" : "fixed"} bottom-3 left-3 right-3 z-50 flex flex-row justify-center sm:rounded-none rounded-full p-3 bg-[#1b1b1ce7] h-14 sm:bottom-0 sm:right-0 sm:left-auto sm:relative sm:flex sm:flex-col items-center sm:justify-between sm:bg-[#06070ae7] sm:h-screen sm:w-14 border-t sm:border-t-0 sm:border-l border-gray-500/10 backdrop-blur-xl`}
    >
      <div className="flex flex-row sm:flex-col items-center  w-full">
        ...
        <div className="flex flex-row sm:flex-col items-center justify-around sm:justify-center w-full py-2 sm:py-4 gap-4 sm:gap-8">
          <Search
            size={24}
...
export default NavigationBar;
>>>>>>> 157487d04d6f61c1538cc1e93e14015b7a55f917
